...
function init() {
  ...
  //btns to eval and clear output information.
...
function cOutput(v){
  ...
  function addOutput(e) {
    ...
    //char was not being cleared from the calc, i struggled with this and it was because output.value += char; was being added at the top, i needed to add it after the condition - "if/else statements" 
